...
This project uses two ASL datasets: **WLASL** and **ASL Citizen** This guide covers how to download and process both.
...
```bash
python3 scripts/download_aslcitizen.py --vocab 300
```
...
```bash
python3 src/train.py --vocab 300 --epochs 50 --d_model 128 --n_layers 3
```
